...
async function getObfuscationParameters(protocol, connection) {
    let init;
    while (true) {
        init = (0, _0_deps_js_1.concat)([crypto.getRandomValues(new Uint8Array(56)), (0, _1_utilities_js_1.bufferFromBigInt)(protocol, 4, false), crypto.getRandomValues(new Uint8Array(4))]);
        if (init[0] == 0xEF) {
            continue;
        }
