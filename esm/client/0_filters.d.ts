...
interface Shortcuts<T extends UpdateIntersection> {
    msg: T["message"] extends object ? T["message"] : T["editedMessage"] extends object ? T["editedMessage"] : T["callbackQuery"] extends object ? T["callbackQuery"]["message"] : undefined;
    ...
    from: T["callbackQuery"] extends object ? T["callbackQuery"]["from"] : T["inlineQuery"] extends object ? T["inlineQuery"]["from"] : T["chosenInlineResult"] extends object ? T["chosenInlineResult"]["from"] : T["message"] extends object ? T["message"]["from"] : T["editedMessage"] extends object ? T["editedMessage"]["from"] : T["preCheckoutQuery"] extends object ? T["preCheckoutQuery"]["from"] : undefined;
